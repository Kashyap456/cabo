...
class MessageSequencer:
    ...
    def create_checkpoint(self, room_id: str, phase: str, data: Dict[str, Any]) -> RoomCheckpoint:
        ...
        logger.info(f"Created checkpoint for room {room_id} at seq {seq_num}, phase {phase}")
        return checkpoint
    ...
    def add_message(self, room_id: str, message_type: str, data: Dict[str, Any]) -> SequencedMessage:
        ...
        logger.debug(f"Added message to room {room_id}: {message_type} seq {seq_num}")
        return message
    ...
    def set_client_sequence(self, room_id: str, session_id: str, seq_num: int):
        ...
        logger.debug(f"Client {session_id} in room {room_id} acked seq {seq_num}")
