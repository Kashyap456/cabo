...
class TestEventDataIntegrity:
    ...
    def test_stack_events_have_correct_data(self):
        ...
        # last event will be turn change, so we need to get the penultimate
        success_event = broadcaster.events[-2]
    ...
    def test_game_end_event_has_complete_scores(self):
        ...
        # Check winner
        # Alice with score 1
        assert event.data["winner_id"] == game.players[0].player_id
