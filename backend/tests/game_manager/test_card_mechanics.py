...
class TestCardDrawing:
    ...
    def test_player_can_draw_card_on_their_turn(self):
        ...
        assert_event_generated(broadcaster, "card_drawn", {"player_id": current_player_id})
...
class TestReplaceAndPlay:
    ...
    def test_player_can_replace_and_play(self):
        ...
        assert_card_is_known(game, current_player_index, 0, True)  # New card should be known
    ...
    def test_cannot_replace_invalid_hand_index(self):
        ...
        game.add_message(ReplaceAndPlayMessage(player_id=current_player_id, hand_index=10))
        events = process_messages_and_get_events(game)
...
class TestDiscardPile:
    ...
    def test_discard_pile_maintains_order(self):
        ...
        first_card = create_specific_card(Rank.KING, Suit.SPADES)
        second_card = create_specific_card(Rank.QUEEN, Suit.HEARTS)
        replace_game_deck(game, [first_card, second_card])
